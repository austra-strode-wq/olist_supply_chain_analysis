...
Other interesting topics worth exploring from business standpoint in the future - geographical angle to seller performance and reliability (Brazil is a large. geographically versatile country, worth exploring trends that makes e-commerce network struggle) and differences between order date, estimated delivery and actual delivery.
## Files
